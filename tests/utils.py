...
import httpx
from sparqlx.types import SPARQLBinding
...
def sparql_result_set_equal(
    result_1: Iterable[SPARQLBinding], result_2: Iterable[SPARQLBinding]
) -> bool:
    def freeze(
        result: Iterable[SPARQLBinding],
    ) -> set[frozenset[tuple[str, SPARQLBinding]]]:
