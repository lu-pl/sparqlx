...
class QueryOperationParametersConstructor(SPARQLOperationParametersConstructor):
    ...
    def get_params(
        ...
        match method:
            case "GET":
                return self._build_get_parameters()
            case "POST":
                return self._build_post_parameters()
            case "POST-direct":
                return self._build_post_direct_parameters()
            case _:
                msg = (
                    "Expected method designator 'GET', 'POST' or 'POST-direct' for query operation."
                    f"Got '{method}'."
                )
                raise ValueError(msg)

    def _build_get_parameters(self) -> SPARQLOperationParameters:
    ...
    def _build_post_parameters(self) -> SPARQLOperationParameters:
        return SPARQLOperationParameters(
            method="POST",
            headers={
    ...
    def _build_post_direct_parameters(self) -> SPARQLOperationParameters:
        return SPARQLOperationParameters(
            method="POST",
            headers={
                "Accept": self._get_response_format(),
...
class UpdateOperationParametersConstructor(SPARQLOperationParametersConstructor):
    ...
    def get_params(
        ...
        match method:
            ...
            case _:
                msg = (
                    "Expected method designator 'POST' or 'POST-direct' for update operation."
                    f"Got '{method}'."
                )
                raise ValueError(msg)
