...
class SPARQLWrapper(AbstractContextManager, AbstractAsyncContextManager):
    ...
    def query(
        ...
        default_graph_uri: RequestDataValue = None,
        named_graph_uri: RequestDataValue = None,
    ) -> httpx.Response | list[SPARQLBinding] | Graph | bool:
    ...
    def queries(
        ...
        *queries: Query,
        ...
        default_graph_uri: RequestDataValue = None,
        named_graph_uri: RequestDataValue = None,
    ) -> Iterator[list[SPARQLBinding] | Graph | bool]: ...
    ...
    def queries(
        ...
        *queries: Query,
        ...
        default_graph_uri: RequestDataValue = None,
        named_graph_uri: RequestDataValue = None,
    ) -> Iterator[httpx.Response | list[SPARQLBinding] | Graph | bool]:
